    ...
    <div>
      ...
      >
        ...
        <div className="font-bold space-y-2 ">
          ...
          <div className="flex flex-row items-start">
            ...
            <div>
              Add browser source on your obs or streaming software and paste the source url.
            </div>
          </div>
          <div className="flex flex-row items-start">
            <div className="mr-2">3.</div>
            <div>Place and adjust the widget on your stream as per your preference.</div>
          </div>
          <div className="flex flex-row items-start text-s-text text-sm px-6">
            <div>
              Don't forget to copy & update source url if you change values other than width &
              height.
            </div>
          </div>
        </div>
      ...
      <div className="">
        ...
        <div className="text-sm font-semibold text-s-text">
          Widgets are a great way to engage with your audience and make your stream more
          interactive.{' '}
          <span className="text-brand cursor-pointer" onClick={() => setOpen(true)}>
            How to add?
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-8 mt-6">
        <div className="">
          <Link href="/dashboard/widgets/chat-box" className="text-p-text no-underline">
          ...
          <div className="text-p-text no-underline">
            <div className="shadow-sm bg-p-bg hover:shadow-md rounded-xl cursor-pointer overflow-hidden transition-all ease-in-out duration-250">
              <video
                ...
                className="w-full"
              />
              <div className="text-lg pt-2 px-4 font-bold">Alert Box (Comming Soon)</div>
              <div className="text-sm pb-4 px-4 font-semibold text-s-text">
