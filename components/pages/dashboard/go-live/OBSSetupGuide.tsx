...
const OBSSetupGuide = () => {
  return (
    <div>
      <video src="/HowToStream.mp4" autoPlay muted loop className="w-full rounded-xl shadow-sm" />
      <div className="font-bold space-y-2 ">
        ...
        <div className="flex flex-row items-start">
          ...
          <div>
            Keep the Default Server and paste the Stream Key from go-live page into the “Stream Key”
            field of OBS.
          </div>
        </div>
        <div className="flex flex-row items-start text-s-text text-sm px-6">
          <div>It is highly recommended to not ignore the streaming service recommendations.</div>
        </div>
      </div>
      ...
      <div className="font-bold space-y-2">
        <div className="flex flex-row items-start">
          ...
          <div className="w-full">
            ...
            <div className="centered-row w-full my-2">
              <img src="/OBSRecommendedSettings.png" className="w-[450px] rounded-xl shadow-xl" />
            </div>
        ...
        <div className="flex flex-row items-start">
          ...
          <div>
            Stay on this go-live page and click the “Start Streaming” button. Stream will start soon
